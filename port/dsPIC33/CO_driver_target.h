...
#define CO_LOCK_EMCY(x)         asm volatile ("disi #0x3FFF")
#define CO_UNLOCK_EMCY(x)       asm volatile ("disi #0x0000")

/* (un)lock critical section when accessing Object Dictionary */
#define CO_LOCK_OD(x)           asm volatile ("disi #0x3FFF")
#define CO_UNLOCK_OD(x)         asm volatile ("disi #0x0000")
